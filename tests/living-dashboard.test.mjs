...
test('Living Map keeps Home inside the lower safe region', () => {
...
test('Living Map places the first area centrally and two areas beside one another', () => {
...
test('Living Map layouts are deterministic and bounded at larger counts', () => {
...
test('Living Dashboard source keeps conceptual mapping honest and relationship-driven', async () => {
