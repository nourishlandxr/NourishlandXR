...
export async function renderProjectDashboard(app, encodedProjectId) {
    ...
    try {
        ...
        app.innerHTML = renderProjectEntry({
            ...
            launchActions: [
                { label: 'Explore with Camera', description: 'Discover information as you move through the landscape.', action: 'window.toggleGlobalAr()' },
