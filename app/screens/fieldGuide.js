        ...
        if (creator) {
            ...
            const creatorCreativeSetup = `<section class="field-guide-secondary-tools" aria-labelledby="fieldGuideCreativeToolsTitle">
                ...
                <div class="field-guide-secondary-tool-list field-guide-management-list">
                    ...
                    <div class="field-guide-management-row is-disabled field-guide-special-elements" aria-disabled="true" aria-label="Special Elements, Coming in V2. Planned capabilities include videos, 3D models and spatial objects, voice guidance and sound."><span class="field-guide-management-row-icon">${webHubIcon('layers')}</span><span class="field-guide-management-row-content"><strong>Special Elements</strong><small>Additional creative content.</small></span><em class="field-guide-management-row-badge">Coming in V2</em></div>
                </div>
            </section>`;
