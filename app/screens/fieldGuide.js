        ...
        if (creator) {
            ...
            app.innerHTML = `<div class="screen field-guide field-guide-hub field-guide-tool field-guide-hub-redesign analog-print-page">
                ...
                <main class="field-guide-workspace">
                    <section class="field-guide-content-create" aria-labelledby="fieldGuideCreateTitle"><div class="field-guide-section-heading"><div><p class="field-guide-section-kicker">Quick actions</p><h2 id="fieldGuideCreateTitle">Add to this project</h2><p>Create a Plant record or add an Area without leaving Content.</p></div></div><div class="field-guide-creation-actions"><button type="button" onclick="window.renderLocationFieldMarker('${encoded(guide.project.id)}','plant','without-ar',true)"><span class="field-guide-creation-action-icon" aria-hidden="true">＋</span><strong>Add Plant</strong><small>Start a saved plant record.</small></button><button type="button" onclick="window.renderProjectAreaForm('${encoded(guide.project.id)}','field-guide')"><span class="field-guide-creation-action-icon" aria-hidden="true">▧</span><strong>Add Area</strong><small>Create a new project workspace.</small></button></div></section>
