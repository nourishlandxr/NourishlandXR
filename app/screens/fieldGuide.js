        ...
        if (creator) {
            const creatorAreaCards = places.map(place => {
                ...
                const totemMarkup = place.hasTotem
                    ? `<span class="field-guide-area-totem" style="--area-totem-color:${totemColor}" aria-label="Area Totem" title="Area Totem">&#x2316;</span>`
                    : '<span class="field-guide-area-totem is-empty" aria-label="No Area Totem">&#x25CB;</span>';
