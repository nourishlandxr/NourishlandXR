...
export async function renderVisitorLocationIntro(app, encodedProjectId, creatorPreview = false, explorePreview = false) {
    ...
    try {
        ...
        const previewNotice = explorePreview ? '<aside class="setup-notice compact-setup-notice"><span>This private project view is reserved for the developing Explorer. Draft content is not published to visitors.</span></aside>' : '';
...
export async function startLocationAr(encodedProjectId) {
    ...
    // Store project ID for AR dashboard to use
