...
const BRIDGE_GROUPS = Object.freeze([
    Object.freeze({
        ...
        question: 'The plant information explains that seed can be harvested, eaten, saved or shared. What good could that do in this place?',
        application: 'Compare local conditions, understand how the plant grows, choose a food-forest function and make a decision that can be reviewed later.',
    ...
    Object.freeze({
        ...
        question: 'The plant information describes nitrogen fixation or useful biomass. How might that function support this soil and the plants around it?',
        application: 'Test the claim against the site, examine soil relationships, choose a useful function and record feedback from the living system.',
    ...
    Object.freeze({
        ...
        question: 'The plant information describes a fast-growing support shrub. Where could that role help, and what could it compete with or shade?',
        application: 'Read the existing landscape, explore plant relationships, place the function within a design and define the outcome you expect.',
    ...
    Object.freeze({
        ...
        question: 'The plant information offers care guidance. Does it fit the conditions visible here, and how will someone know whether it worked?',
        application: 'Read climate and growth in place, plan stewardship and return through feedback instead of treating general guidance as a fixed rule.',
    ...
    Object.freeze({
        ...
        question: 'The plant information can preserve a use or tradition. Who provided that knowledge, what context belongs with it, and what should not be claimed?',
        application: 'Examine the source, understand the people and place involved, name limitations and make a responsible decision about sharing.',
