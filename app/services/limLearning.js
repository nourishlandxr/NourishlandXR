...
export const LIM_INTRO_CELLS = Object.freeze([
    {id:'lim-intro-vision',title:'Vision',accent:'#dcef95',content:'NourishlandXR begins with a vision: use technology to help people notice, understand and care for living systems. The mesh turns that intention into connected ways of seeing, learning, designing and acting.',lookFor:'A place is never only a backdrop. Plants, people, weather, time and care are part of the same living story.',question:'What would you notice if the interface helped you look more closely instead of giving you an answer first?',next:'Select Analysis, Literacy, Food forest or Smart to choose a way into the story.'},
    {id:'lim-intro-analysis',title:'Analysis',accent:'#6978b8',content:'Analysis reads the conditions already shaping a place before a solution is proposed. Climate, topography and landscape patterns reveal constraints, opportunities and relationships that a single photograph can hide.',lookFor:'Sun, shade, slope, water movement, wind, access and signs of existing life.',question:'Which condition is shaping the place most strongly right now, and what evidence supports that reading?',next:'Compare Climate, Topography and Landscape before opening Strategy.'},
    ...
    {id:'lim-intro-smart',title:'Smart',accent:'#4f879e',content:'Smart tools help turn observations into useful decisions. Clear goals, measurable outcomes and honest limits keep technology connected to the living place it serves; the interface should make care more informed, never replace care.',lookFor:'A decision that needs evidence, a person responsible for it and the moment when it should be reviewed.',question:'What can the system help you notice, and what must remain a human judgement in the place?',next:'Open Goals, Outcomes, Limitations or Challenges to make the loop explicit.'},
