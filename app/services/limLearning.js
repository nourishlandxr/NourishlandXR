...
export const LIM_INTRO_CELLS = Object.freeze([
    introCell({id:'lim-intro-vision',title:'Vision',accent:'#dcef95',topics:['Read the place','Understand life','Design the forest','Shape the outcome'],content:'NourishlandXR begins with a vision: use technology to help people notice, understand and care for living systems. The mesh turns that intention into a cycle of seeing, learning, designing, acting and returning to observe what changed.',lookFor:'A place is never only a backdrop. Plants, people, weather, time and care are part of the same living story.',question:'What would you notice if the interface helped you look more closely instead of giving you an answer first?',next:'Select Read the Place, Understand Life, Design the Forest or Shape the Outcome to choose a way into the story.'}),

    introCell({id:'lim-intro-analysis',parentId:'lim-intro-vision',title:'Read the Place',accent:'#6978b8',topics:['Climate','Topography','Landscape','Strategy'],relatedIds:['lim-intro-smart-feedback'],content:'Read the Place begins with the conditions already shaping a site before a solution is proposed. Climate, topography, landscape patterns and practical strategy reveal constraints, opportunities and relationships that a single photograph can hide.',lookFor:'Sun, shade, slope, water movement, wind, access, existing vegetation, human use and signs of change through time.',question:'Which condition is shaping the place most strongly right now, and what evidence supports that reading?',next:'Compare Climate, Topography and Landscape, then use Strategy to choose the next useful observation.'}),
    ...
    introCell({id:'lim-intro-smart',parentId:'lim-intro-vision',title:'Shape the Outcome',accent:'#4f879e',topics:['Goals','Outcomes','Limitations','Challenges','Decisions','Feedback'],content:'Shape the Outcome turns observations into useful decisions. Clear goals, measurable outcomes, honest limits, practical choices and feedback keep technology connected to the living place it serves; the interface should inform care rather than replace it.',lookFor:'A decision that needs evidence, the people affected, a responsible person and the moment when the result should be reviewed.',question:'What can the system help people notice, and what must remain a human judgement made in the place?',next:'Choose a goal or decision, make uncertainty visible, then return through Feedback to Read the Place again.'}),
