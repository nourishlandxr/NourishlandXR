...
export const LIM_INTRO_CELLS = Object.freeze([
    {id:'lim-intro-vision',title:'Vision',accent:'#dcef95',content:'NourishlandXR begins with a vision: use technology to help people notice, understand and care for living systems. The mesh turns that intention into connected ways of seeing, learning, designing and acting.',lookFor:'A place is never only a backdrop. Plants, people, weather, time and care are part of the same living story.',question:'What would you notice if the interface helped you look more closely instead of giving you an answer first?',next:'Select Place, Life, Forest or Purpose to choose a way into the story.'},
    {id:'lim-intro-analysis',title:'Read the Place',accent:'#6978b8',content:'Read the Place begins with the conditions already shaping a site before a solution is proposed. Climate, topography and landscape patterns reveal constraints, opportunities and relationships that a single photograph can hide.',lookFor:'Sun, shade, slope, water movement, wind, access and signs of existing life.',question:'Which condition is shaping the place most strongly right now, and what evidence supports that reading?',next:'Compare Climate, Topography and Landscape before opening Strategy.'},
    {id:'lim-intro-analysis-climate',title:'Climate',accent:'#6978b8',content:'Climate describes recurring patterns of temperature, rainfall, season and exposure. A broad climate label is only a starting point: buildings, hollows, canopy and recent weather create local microclimates.',lookFor:'Frost pockets, heat reflected from surfaces, damp edges, wind exposure and seasonal timing.',question:'Where does this place behave differently from the wider climate description?',next:'Pair climate with Topography to explain why conditions change across a few metres.'},
    {id:'lim-intro-analysis-topography',title:'Topography',accent:'#6978b8',content:'Topography is the shape and slope of land. It influences water movement, sun, wind, access and where different growing conditions form, so a small change in level can change what is possible.',lookFor:'High and low points, contours, runoff paths, erosion, stable ground and difficult access.',question:'Where would water, people and roots naturally travel if no path had been built?',next:'Connect the landform to Landscape and then to a practical Strategy.'},
    {id:'lim-intro-analysis-landscape',title:'Landscape',accent:'#6978b8',content:'Landscape brings landform, water, soil, vegetation, built elements and people into one view. Read their relationships before isolating a single feature; the most useful pattern is often between two things.',lookFor:'Edges, transitions, shelter, competing uses, existing care and places where life is already thriving.',question:'What relationship is easy to miss when the view is divided into separate objects?',next:'Use Strategy to turn this reading into a careful next step.'},
    {id:'lim-intro-analysis-strategy',title:'Strategy',accent:'#6978b8',content:'Strategy connects what a place is now with careful next steps. Useful strategies respond to evidence, available care and the way conditions may change instead of forcing a fixed plan onto a living system.',lookFor:'The smallest reversible action that could test an assumption without damaging the place.',question:'What would you try first, how would you know whether it helped, and when would you review it?',next:'Move into Literacy to choose plants and relationships that suit the strategy.'},
    {id:'lim-intro-literacy',title:'Understand Life',accent:'#719b62',content:'Understand Life builds the ability to read plants and living relationships. Identification, guilds, growth and harvest become a practical language for exploring a place while keeping observation separate from assumption.',lookFor:'Form, growth habit, life cycle, neighbours, signs of stress and signs of support.',question:'What can be described directly, and what still needs evidence or a second observation?',next:'Open Plants, Guilds, Grow or Fruit to make the reading more specific.'},
    {id:'lim-intro-literacy-plants',title:'Plants',accent:'#719b62',content:'Plants can be read through identity, form, life cycle, needs and relationships. Begin with direct observation and keep uncertainty visible; a careful “not sure yet” protects the quality of everything built on the identification.',lookFor:'Leaves, stems, bark, branching, scale, season and the features that distinguish similar species.',question:'Which feature would another observer need in order to check your identification?',next:'Follow the plant into Guilds and Grow rather than treating its name as the end of the inquiry.'},
    {id:'lim-intro-literacy-guilds',title:'Guilds',accent:'#719b62',content:'A guild is a useful way to explore plants that may support shared functions such as food, shade, habitat, fertility or access. It is a hypothesis about relationships, not a promise that every companion will work in every place.',lookFor:'Shared resources, flowering times, root zones, habitat, competition and the people who will care for the planting.',question:'Which relationship has been observed here, and which one is still only a design idea?',next:'Use Function and Energy to test whether the proposed guild is doing useful work.'},
    {id:'lim-intro-literacy-grow',title:'Grow',accent:'#719b62',content:'Growing knowledge joins propagation, establishment, seasonal care and long-term observation. The method should suit the species, place and people caring for it; a technically possible method can still be a poor local choice.',lookFor:'Watering, roots, protection, timing, failure points and the care that is realistically available.',question:'What does this plant need during its first season, and who will notice if that need is missed?',next:'Connect growing practice to Soil, Climate and Succession.'},
    {id:'lim-intro-literacy-fruit',title:'Fruit',accent:'#719b62',content:'Fruit connects plant identity with flowering, pollination, season, harvest and use. A harvest is also evidence of how a plant responds to its place, so record timing and conditions rather than treating yield as a fixed promise.',lookFor:'Flowering, pollinators, fruit set, ripeness, damage, harvest method and what remains for wildlife.',question:'What changed between flowering and harvest, and what might explain that change?',next:'Follow the evidence into Uses and the local observation record.'},
    {id:'lim-intro-food-forest',title:'Design the Forest',accent:'#a06a43',content:'Design the Forest uses ecological patterns to create productive living landscapes. Layers, relationships and succession guide design while observation keeps it grounded in place; the model is a prompt for thinking, not a rigid recipe.',lookFor:'Canopy, understorey, shrubs, herbs, ground cover, climbers, roots, paths and access for care.',question:'Which layer or function is missing, overloaded or doing more than one job?',next:'Open Function, Energy, Design or Succession to unpack the system.'},
    {id:'lim-intro-food-function',title:'Function',accent:'#a06a43',content:'Function asks what each element contributes: food, shade, habitat, shelter, access, fertility or another role. One element may perform several functions, and a function only matters if it works for this place and the people maintaining it.',lookFor:'Outputs, support roles, maintenance burden, seasonal gaps and useful overlaps between plants.',question:'What job is this element doing, and what evidence shows that the job is being done?',next:'Use Energy and Design to place functions where they can work together.'},
    {id:'lim-intro-food-energy',title:'Energy',accent:'#a06a43',content:'Sunlight, water, wind, organic matter and human effort move through a food forest. Good design notices where energy arrives, where it is stored and where it is lost, then reduces needless work without pretending that care can be removed.',lookFor:'Sun paths, shade, runoff, wind, mulch, fertility cycles, tool access and repeated maintenance.',question:'Where is energy being wasted, and where could a living relationship do the work instead?',next:'Connect Energy to Design, Soil and the timing of Succession.'},
    {id:'lim-intro-food-design',title:'Design',accent:'#a06a43',content:'Design arranges plants, paths, water and access around real goals and conditions. It grows stronger through observation, testing and adjustment; a good design leaves room for people, seasons and plants to change it.',lookFor:'Scale, spacing, sight lines, access, safety, water, future canopy and the cost of care.',question:'What is the smallest design move that would make the next season easier to learn from?',next:'Use Smart to record the goal, outcome and limitation of the experiment.'},
    {id:'lim-intro-food-succession',title:'Succession',accent:'#a06a43',content:'Succession is change through time. Early plants prepare conditions for later ones, while a food forest shifts in shade, structure and care as it matures; planning for that change prevents today’s solution becoming tomorrow’s obstacle.',lookFor:'Fast and slow growers, changing light, soil cover, mortality, recruitment and changing maintenance needs.',question:'What is this planting preparing for, and what will need to change when the canopy closes?',next:'Return to Goals and Outcomes to make the change visible over time.'},
    {id:'lim-intro-smart',title:'Shape the Outcome',accent:'#4f879e',content:'Shape the Outcome turns observations into useful decisions. Clear goals, measurable outcomes and honest limits keep technology connected to the living place it serves; the interface should make care more informed, never replace care.',lookFor:'A decision that needs evidence, a person responsible for it and the moment when it should be reviewed.',question:'What can the system help you notice, and what must remain a human judgement in the place?',next:'Open Goals, Outcomes, Limitations or Challenges to make the loop explicit.'},
    {id:'lim-intro-smart-goals',title:'Goals',accent:'#4f879e',content:'Goals describe the change a project is trying to create. A clear goal makes it easier to choose what to observe, build and measure, and it gives a team a shared reason for returning to the site.',lookFor:'Who benefits, what changes, where it changes and the time horizon that makes the goal meaningful.',question:'Can the goal be understood by the person caring for the place without opening the interface?',next:'Define an Outcome that would let you recognise progress.'},
    {id:'lim-intro-smart-outcomes',title:'Outcomes',accent:'#4f879e',content:'Outcomes are the changes that follow from action. Compare intended results with what actually happens, including effects that were not expected; a surprising outcome is often the beginning of better knowledge.',lookFor:'A visible change, a useful measure, a time window and effects on other plants, people or wildlife.',question:'What would count as evidence of progress, and what result would make you change course?',next:'Record Limitations so the outcome is interpreted with the right level of confidence.'},
    {id:'lim-intro-smart-limitations',title:'Limitations',accent:'#4f879e',content:'Every tool and dataset has limits. Naming missing evidence, uncertain identification, uneven observation and technical constraints makes the knowledge more useful and trustworthy; uncertainty is information when it is visible.',lookFor:'What was not measured, who was absent, which source is old and where the interface may create false confidence.',question:'What would you need to know before making a stronger claim?',next:'Turn the gap into a Challenge or a new local observation.'},
    {id:'lim-intro-smart-challenges',title:'Challenges',accent:'#4f879e',content:'Challenges reveal where more observation, support or experimentation is needed. They can become learning questions instead of hidden failures when the record keeps the problem, attempted response and next review together.',lookFor:'The bottleneck, the people affected, the smallest safe experiment and the signal that would show learning.',question:'What is the next useful question, and who can help answer it in the living place?',next:'Return to Vision with a richer understanding and let the mesh keep growing.'}
...
export function limLearningContent(labelOrId) {
    ...
    const body = cell?.layoutRole === 'intro'
        ? [cell.content, cell.lookFor && `Look for · ${cell.lookFor}`, cell.question && `Ask · ${cell.question}`, cell.next && `Next · ${cell.next}`].filter(Boolean).join('\n\n')
